...
const (
	FinalizerString = "finalizers.efs.services.k8s.aws/ReplicationConfiguration"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("replicationconfigurations")
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReplicationConfiguration),
	}
}
