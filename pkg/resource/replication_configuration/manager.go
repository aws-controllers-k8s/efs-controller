...
// +kubebuilder:rbac:groups=efs.services.k8s.aws,resources=replicationconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=efs.services.k8s.aws,resources=replicationconfigurations/status,verbs=get;update;patch
