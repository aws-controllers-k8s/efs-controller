...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.SourceFileSystemID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["sourceFileSystemID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: sourceFileSystemID"))
	}
	r.ko.Spec.SourceFileSystemID = &tmp
