...
func (in *FileSystemSpec) DeepCopyInto(out *FileSystemSpec) {
	*out = *in
	...
	if in.ReplicationConfiguration != nil {
		...
		*out = make([]*DestinationToCreate, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(DestinationToCreate)
...
func (in *FileSystemStatus) DeepCopyInto(out *FileSystemStatus) {
	*out = *in
	...
	if in.ReplicationConfigurationStatus != nil {
		in, out := &in.ReplicationConfigurationStatus, &out.ReplicationConfigurationStatus
...
func (in *ReplicationConfigurationDescription) DeepCopyInto(out *ReplicationConfigurationDescription) {
	*out = *in
	...
	if in.SourceFileSystemOwnerID != nil {
		in, out := &in.SourceFileSystemOwnerID, &out.SourceFileSystemOwnerID
		*out = new(string)
		**out = **in
	}
